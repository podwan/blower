...
{         
    ...
    //f(PLL_P) = 320MHz /8 = 40MHz		for ADC
    RCC->PLLCFGR &= 0x008c800c;
    RCC->PLLCFGR |= 0x41012812; //M = 2 N = 40 R = 2 PLLRCLK = 160MHZ		HSI16
...
static void PwmInit(void)
{
    ...
    TIM8->CCR2 = 1000;
	TIM8->CCR3 = 1000;
    TIM8->CCR4 = (PWM_PERIOD_VALUE >> 1) - 2; //设定触发点 3198
    
	TIM8->BDTR = 0;
    TIM8->BDTR |= 0x000e08a0; 		//filter 2.4us	OSSR=1	死区 (64 + 32) x 2 x 1/80 = 2.4us
...
static void AdcInit(void)
{
	...
	//采样时间
    ADC1->SMPR1 = 0x12492492;  //12.5 + 12.5 = 25 ADC Clock cycles * （1/40MHz） =  625ns
    ...
    ADC2->SMPR1 = 0x12492492;  //12.5 + 12.5 = 15 ADC Clock cycles * （1/40MHz） =  625ns
